...
import { AcosPRPrService } from './acosprpr.service';
import { AcosPRPrModel, dataModel, Tabla3Model } from './acosprpr.model';
...
@Component({
    selector: 'acosprpr',
    templateUrl: './acosprpr.template.html',
    styleUrls: [
        '../../scss/elements.style.scss',
        '../../scss/notifications.style.scss'],
    providers: [AcosPRPrService,DashBoardFormErrorsService],
    encapsulation: ViewEncapsulation.None,
})
export class AcosPRPrComponent implements OnInit {
    injector: Injector;
    ...
    constructor(private router: Router,
        ...
        private servicio:AcosPRPrService,
    ...
    createForm() {
        ...
        this.ifForm = this.fb.group({
            ...
            preg_671_tabla_3: this.fb.array([])
      ...
      this.servicio.getDatosModelo().subscribe(
            response => {               
                ...
                if (this.status !== "success") {
                    ...
                    this.setPregunta(response.preg_671_tabla_3, 'preg_671_tabla_3');
        ...
        this.servicio.setDatosModelo(this.modelo)
            ...
            response => {
                ...
                if (this.status !== "success") {
                    ...
                    this.ifForm.markAsPristine();  
                    if (redirigir) {
                        this.router.navigate(["/app/rrpppr"]);
                    }
                    Messenger().post({
    ...
    preparaParaGuardar(): AcosPRPrModel {
        const formModel = this.ifForm.value;        
        const saveClasAcosPRpr: any = {
            data: formModel.data,
            preg_671_tabla_3: formModel.preg_671_tabla_3.map((datos: Tabla3Model) => Object.assign({}, datos))
        };
        return saveClasAcosPRpr;
    }
}